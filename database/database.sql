...
--
-- Host: 127.0.0.1    Database: staff_management_system
-- ------------------------------------------------------
...
CREATE TABLE `attendance` (
  ...
  `check_method` enum('QR','RFID','Manual') DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `leave_requests` (
  ...
  CONSTRAINT `leave_requests_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`id`),
...
CREATE TABLE `payroll` (
  ...
  `status` enum('Draft','PendingApproval','Approved','Locked') DEFAULT NULL,
...
INSERT INTO `roles` VALUES (1,'Admin',100,'Top level control'),(2,'Admin',70,'Full management access'),(3,'Staff',10,'Basic employee access');
...
CREATE TABLE `task_assignments` (
  ...
  CONSTRAINT `task_assignments_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  KEY `staff_id` (`staff_id`),
  KEY `role_id` (`role_id`),
  CONSTRAINT `users_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`id`),
...
-- Dump completed on 2026-02-27 19:34:49
